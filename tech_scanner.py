...
def load_daily_targets():
    """Reads the fundamentally sound tickers generated by the pre-market sweep."""
    file_path = os.path.join(os.path.dirname(__file__), "daily_targets.txt")
    if not os.path.exists(file_path):
        print("⚠️ No daily_targets.txt found. Did the fundamental scanner run?")
        return []
...
def run_market_scan():
    ...
    print(f"📋 Loaded {len(watchlist)} fundamentally approved targets for technical screening.")
